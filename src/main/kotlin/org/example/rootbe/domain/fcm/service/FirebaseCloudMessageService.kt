package org.example.rootbe.domain.fcm.service
...
import org.example.rootbe.domain.fcm.presentation.dto.FcmMessage
...
class FirebaseCloudMessageService(
    ...
    @Async
    fun sendAllUsers(request: GenerateNotificationRequest) {
    ...
    private fun saveNotification(request: GenerateNotificationRequest) {
